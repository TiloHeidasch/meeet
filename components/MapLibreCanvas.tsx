...
const PIN_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 20" aria-hidden="true"><path d="M7,0 C3.134,0 0,3.134 0,7 C0,10.866 7,20 7,20 C7,20 14,10.866 14,7 C14,3.134 10.866,0 7,0" fill="#FFFFFF" /><path d="M7,17 C7,17 2,10 2,7 C2,4.243 4.243,2 7,2 C9.757,2 12,4.243 12,7 C12,10 7,17 7,17" fill="currentColor" /><path d="M9,7.219 C9,8.324 8.105,9.219 7,9.219 C5.895,9.219 5,8.324 5,7.219 C5,6.114 5.895,5.219 7,5.219 C8.105,5.219 9,6.114 9,7.219" fill="#FFFFFF" /></svg>';
