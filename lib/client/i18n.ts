...
const en = {
  ...
  location: {
    ...
    currentLocationAria: (number: number, loading: boolean) => `${loading ? "Finding your current location…" : "Use my current location"} · Participant ${number}`,
    locating: "Finding your current location…",
    locationSet: "Current location added",
    coordinateLabel: (latitude: number, longitude: number) => `Coordinates ${latitude.toFixed(5)}, ${longitude.toFixed(5)}`,
    geolocationPermissionDenied: "Location access was denied. Allow it in your browser settings or search for a starting point instead.",
    geolocationUnavailable: "Your current location is unavailable right now. Search for a starting point instead.",
    geolocationTimeout: "Finding your current location took too long. Try again or search for a starting point.",
    geolocationInsecure: "Current location requires a secure connection. Search for a starting point instead.",
    geolocationUnsupported: "Your browser does not provide current location. Search for a starting point instead.",
    geolocationUnknown: "Your current location could not be found. Search for a starting point instead.",
  },
  legend: {
...
const de: Messages = {
  ...
  location: {
    ...
    currentLocationAria: (number: number, loading: boolean) => `${loading ? "Dein aktueller Standort wird gesucht…" : "Meinen aktuellen Standort verwenden"} · Teilnehmer ${number}`,
    locating: "Dein aktueller Standort wird gesucht…",
    locationSet: "Aktueller Standort hinzugefügt",
    coordinateLabel: (latitude: number, longitude: number) => `Koordinaten ${latitude.toFixed(5)}, ${longitude.toFixed(5)}`,
    geolocationPermissionDenied: "Der Standortzugriff wurde verweigert. Erlaube ihn in den Browsereinstellungen oder suche stattdessen nach einem Startpunkt.",
    geolocationUnavailable: "Dein aktueller Standort ist gerade nicht verfügbar. Suche stattdessen nach einem Startpunkt.",
    geolocationTimeout: "Die Suche nach deinem aktuellen Standort hat zu lange gedauert. Versuche es erneut oder suche nach einem Startpunkt.",
    geolocationInsecure: "Der aktuelle Standort benötigt eine sichere Verbindung. Suche stattdessen nach einem Startpunkt.",
    geolocationUnsupported: "Dein Browser stellt keinen aktuellen Standort bereit. Suche stattdessen nach einem Startpunkt.",
    geolocationUnknown: "Dein aktueller Standort konnte nicht ermittelt werden. Suche stattdessen nach einem Startpunkt.",
  },
  legend: {
